    ...
    <div className="min-h-screen pb-12 flex flex-col bg-[#FAF9F6]">
      ...
      <div className="px-5 -mt-10 relative z-10 space-y-4 max-w-2xl mx-auto w-full">
        <div className="grid grid-cols-1 gap-3">
          ...
          />
          <ActionCard 
            href={RESTAURANT_DATA.instagram}
            title="Instagram Feed"
            description="See our latest culinary creations"
          ...
          />
          <ActionCard 
            href={RESTAURANT_DATA.whatsapp}
            title="WhatsApp Community"
            description="Join for updates & exclusive offers"
        ...
        {/* Bottom Social Icons */}
        <div className="flex justify-center items-center space-x-8 pt-8 pb-4">
          ...
          <a href={RESTAURANT_DATA.whatsapp} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-green-600 transition-all transform hover:scale-125">
