...
const App: React.FC = () => {
  return (
    <div className="min-h-screen pb-12 flex flex-col bg-[#FAF9F6]">
      ...
      <div className="relative h-[48vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
          ...
          <div className="flex items-center justify-center space-x-2 mt-4">
            ...
            <p className="text-white text-xs font-bold tracking-[0.4em] uppercase drop-shadow-md">
              Exquisite Indian Flavors
            </p>
            <span className="h-[1px] w-8 bg-white/40"></span>
          </div>
        </div>
      ...
      <div className="px-6 -mt-12 relative z-10 space-y-4 max-w-2xl mx-auto w-full">
        <div className="grid grid-cols-1 gap-4">
          <ActionCard 
            href={RESTAURANT_DATA.menu}
            title="Digital Menu"
            description="Our curated selection of flavors"
          ...
          <ActionCard 
            ...
            title="Order Online"
            description="Fast, fresh delivery & pickup"
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 mt-8">
          ...
          <p className="text-sm text-gray-600 leading-relaxed mb-4">
            Welcome to <span className="font-bold text-sai-red">{RESTAURANT_DATA.name}</span>. We bring you the heart of India through authentic spices and traditional techniques. Every dish is a journey through India's rich culinary heritage.
          </p>
          <div className="flex items-center space-x-3 pt-3 border-t border-gray-50">
            <a 
              ...
              className="text-xs font-bold text-sai-green uppercase tracking-widest hover:text-sai-red transition-colors"
            >
              Official Website
            </a>
          </div>
        ...
        <div className="flex justify-center space-x-6 pt-8">
          <a href={RESTAURANT_DATA.facebook} target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center text-blue-600 transition-all hover:scale-110 active:scale-90">
            <svg className="w-7 h-7 fill-current" viewBox="0 0 24 24"><path d="M22.675 0h-21.35C.597 0 0 .597 0 1.326v21.348C0 23.403.597 24 1.325 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116c.73 0 1.325-.597 1.325-1.326V1.326C24 .597 23.403 0 22.675 0z"/></svg>
          </a>
          <a href={RESTAURANT_DATA.instagram} target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center text-pink-600 transition-all hover:scale-110 active:scale-90">
